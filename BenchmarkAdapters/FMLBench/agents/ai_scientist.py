"""AweAI AiScientist FML adapter using its native TerminalTaskSubagent."""
...
class AiScientistFMLAdapter(FMLAgentAdapter):
    ...
    def build_native_command(self, context: FMLAgentLaunchContext, prompt: str) -> CommandSpec:
        return native_python_command(
            ...
            module="BenchmarkAdapters.FMLBench.agents.ai_scientist",
            source_root=ROOT / "BenchmarkAdapters/environments/terminal/ai-scientist/.venv/agent-source/src",
            label="AweAI AiScientist native Subagent FML loop",
        )
...
__all__ = ["AiScientistFMLAdapter", "run_native_loop"]
