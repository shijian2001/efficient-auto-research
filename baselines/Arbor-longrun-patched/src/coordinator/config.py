...
class CoordinatorConfig(ProxyModel):
    ...
    # Autonomous long-run mode: keep the coordinator alive through a
    # text-only model completion until the orchestrator's budget cutoff.
    continue_until_budget: bool = False
    ...
    def to_executor_config(self, idea_id: str, idea_hypothesis: str) -> "AgentConfig":
        ...
        executor_config = AgentConfig(
            ...
            continue_until_budget=self.continue_until_budget,
            auto_git=True,
